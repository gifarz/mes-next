export const en = {
  ...
  deleteOrderConfirmation: "Are you sure you want to delete Order Number",
  cantBeReverse: "This cannot be reversed",

  successAlarm: "Successfully Insert Alarm",
  failAlarm: "Failed to Insert Alarm",
  successUpdateAlarm: "Alarm Updated Successfully",
  failUpdateAlarm: "Alarm Not Found or No Changes Applied",
  successCloseAlarm: "Alarm Closed Successfully",

  pleaseFillForm: "Please Fill The Form",
  operator: "Operator",
  chooseShift: "Choose Shift",
  selectShift: "Select the Shift",
  chooseStation: "Choose the Station",
  chooseLeader: "Choose Leader",
  enterLeader: "Enter Your Leader",
  foreman: "Foreman",
  enterForeman: "Enter Your Foreman",
  shift: "Shift",
  leader: "Leader",
  line: "Line",
  ...
  alarmNamePlaceholder: "Input the Alarm Name",
  openBy: "Open By",
  openByPlaceholder: "Input the Opened By",
  alarmStatus: "Alarm Status",
  alarmStatusPlaceholder: "Input the Alarm Status",
  closedBy: "Closed By",
  closedByPlaceholder: "Input the Closed By",
  closedDate: "Closed Date",
  closedDatePlaceholder: "Input the Closed Date",
  openDate: "Open Date",
  openDatePlaceholder: "Input the Open Date",
  note: "Note",
  notePlaceholder: "Input the Note",
